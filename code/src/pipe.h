 ...
 */
 ...
 struct Pipe_State {
   ...
   /* cache stall info */
   int fetch_stall;  /* remaining stall cycles for instruction cache miss */
   int mem_stall;    /* remaining stall cycles for data cache miss */

   /* pending data from cache accesses (to avoid double-access after stall) */
